...
class VoiceControlAssistant:
    ...
    def _create_tray_icon(self):
        ...
        menu = pystray.Menu(
            pystray.MenuItem("Activar", lambda _, __: (self.activate() or True)),
            pystray.MenuItem("Desactivar", lambda _, __: (self.deactivate() or True)),
            pystray.MenuItem("Mostrar ayuda", lambda _, __: (self.show_help() or True)),
            pystray.MenuItem("Salir", lambda _, __: (self.stop() or True)),
        )
