...
class VoiceControlAssistant:
    ...
    def _handle_command(self, text: str):
        ...
        if getattr(self, 'dictation_mode', False):
            try:
                ...
                for cmd_key in ('dictation_off', 'modo_deletrear', 'salir_modo_deletrear', 'correct_last'):
    ...
    def _correct_last_phrase(self):
        ...
        # open correction window directly on the command thread
        try:
            self._open_correction_window(phrase_text)
        except Exception as e:
