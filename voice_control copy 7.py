...
class VoiceControlAssistant:
    ...
    def _init_command_handlers(self):
        ...
        spell_map = {
            'alicante':'a','bilbao':'b','cadiz':'c','dinamarca':'d','espana':'e','francia':'f','gerona':'g','huelva':'h','italia':'i','jaen':'j',
        ...
        special_map = {
            'comillas':'"','comillas simples':'\'','mas':'+','menos':'-','asterisco':'*','dolar':'$','abrir parentesis':'(',
            'cerrar parentesis':')','abrirllave':'{','cerrar llave':'}','abrir corchete':'[','cerrar corchete':']','subrayado':'_','subrrayado':'_','barrainvertida':'\\',
    ...
    def _strip_command_prefix(self, text: str):
        ...
        if not text:
            return text
        try:
            return re.sub(r"^\s*comando\b[\s,:-]*", "", text, flags=re.I)
        except Exception:
            return text
